...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            checkSignInExceptions("java_skypro_goasdddddddddddddgfdgdfgs", "D_1hWiKjjP_9", "D_1hWiKjjP_9");
        } catch (WrongLoginException | WrongPasswordException e) {
            System.out.println("Случилось: " + e);
        }
        ...
        try {
            checkSignInExceptions("java_skypro_go", "D_1hWiKjjP_9dgfgdfagadfagfdagfdagdfagdfgfadagfd", "D_1hWiKjjP_9");
        } catch (WrongLoginException | WrongPasswordException e) {
            System.out.println("Случилось: " + e);
        }
        ...
        try {
            checkSignInExceptions("java_skypro_go", "D_1hWiKjjP_9", "D_1hWiKjjP_91");
        } catch (WrongLoginException | WrongPasswordException e) {
            System.out.println("Случилось: " + e);
        }
    }
